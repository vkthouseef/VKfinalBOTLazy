        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                await msg.message.reply_text(text=f"Hello my Love <a href='https://t.me/{message.username}'>{message.first_name}</a>, Your request has been sent to our admin dashboard !\nPlease keep some patience !. i promice, They will upload it as soon as possible dear love ❤️!", reply_to_message_id=reply_id , reply_markup=(InlineKeyboardMarkup=[[InlineKeyboardButton("❤️ Thank You ❤️", callback_data="close_data")],
                                                                                                                                                                                                                                                                                                                                                              [InlineKeyboardButton("🦋 Share Real_MoviesAdda 🦋", url="https://t.me/real_MoviesAdda2")], [InlineKeyboardButton("🏹 Add me to your group 🏹", url="http://t.me/{temp.U_NAME}?startgroup=true")]]))
